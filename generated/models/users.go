...
type User struct {
	...
	PWHash string `boil:"pw_hash" json:"pw_hash" toml:"pw_hash" yaml:"pw_hash"`
...
var UserWhere = struct {
	...
	PWHash whereHelperstring
}{
	ID:     whereHelperint{field: "`users`.`id`"},
	Name:   whereHelperstring{field: "`users`.`name`"},
	PWHash: whereHelperstring{field: "`users`.`pw_hash`"},
}
...
var (
	userAllColumns            = []string{"id", "name", "pw_hash"}
	userColumnsWithoutDefault = []string{"id", "name", "pw_hash"}
